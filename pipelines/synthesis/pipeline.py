...
def create_pipeline() -> Pipeline:
	...
	return Pipeline([
			node(
				nodes.consolidate_time_series_dataframes,
				dict(
					covid_time_series="covid_time_series",
					google_trends="google_trends",
					gds_country_searches="gds_country_searches",
					dds_country_bookings_by_travel_date="dds_country_bookings_by_travel_date",
					...
					oag_time_series="oag_time_series_dataset",
				),
				"combined_time_series"),
			node(
				nodes.identify_change_points,
				["combined_time_series", "params:change_point_columns"],
				"change_points"),
			node(
				nodes.add_geographical_mappings,
				["change_points", "country_mappings"],
				"time_series_dataset"),
			node(
				nodes.compute_scorecard,
				["time_series_dataset", "country_restrictions_matrix"],
				"scorecard_dataset"),
	])
